...
class WP_Job_Manager_Company_Listings_Admin {
	...
	public function admin_enqueue_scripts() {
		...
		wp_enqueue_style( 'company_manager_admin_css', COMPANY_LISTINGS_PLUGIN_URL . '/assets/css/admin.css' );
		...
		wp_enqueue_script( 'company_manager_admin_js', COMPANY_LISTINGS_PLUGIN_URL. '/assets/js/admin.min.js', array( 'jquery', 'jquery-tiptip', 'jquery-ui-datepicker', 'jquery-ui-sortable' ), COMPANY_LISTINGS_VERSION, true );
	}
	...
	public function admin_menu() {
		add_submenu_page( 'edit.php?post_type=company', __( 'Settings', 'wp-job-manager-company-listings' ), __( 'Settings', 'wp-job-manager-company-listings' ), 'manage_options', 'company-manager-settings', array( $this->settings_page, 'output' ) );
	}
}
