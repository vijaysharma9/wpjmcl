...
class WP_Resume_Manager_Admin {
	...
	public function admin_enqueue_scripts() {
		...
		wp_enqueue_style( 'resume_manager_admin_css', COMPANY_LISTINGS_PLUGIN_URL . '/assets/css/admin.css' );
		...
		wp_enqueue_script( 'resume_manager_admin_js', COMPANY_LISTINGS_PLUGIN_URL . '/assets/js/admin.min.js', array( 'jquery', 'jquery-tiptip', 'jquery-ui-datepicker', 'jquery-ui-sortable' ), COMPANY_LISTINGS_VERSION, true );
	}
