...
class WP_Job_Manager_Company_Listings_Geocode {
	...
	public function __construct() {
		add_action( 'company_listings_update_company_data', array( $this, 'update_location_data' ), 20, 2 );
		add_action( 'company_listings_company_location_edited', array( $this, 'change_location_data' ), 20, 2 );
	}
	...
	public function update_location_data( $company_id, $values ) {
		if ( apply_filters( 'company_listings_geolocation_enabled', true ) ) {
