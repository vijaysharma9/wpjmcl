...
include_once( 'class-wp-job-manager-company-listings-form-submit-resume.php' );

/**
 * WP_Job_Manager_Company_Listings_Form_Edit_Resume class.
 */
class WP_Job_Manager_Company_Listings_Form_Edit_Resume extends WP_Job_Manager_Company_Listings_Form_Submit_Resume {

	public $form_name = 'edit-resume';

	/** @var WP_Job_Manager_Company_Listings_Form_Edit_Resume The single instance of the class */
