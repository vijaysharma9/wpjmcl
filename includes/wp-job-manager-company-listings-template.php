...
function the_candidate_photo( $size = 'thumbnail', $default = null, $post = null ) {
	...
	if ( $logo ) {
		...
		echo '<img class="candidate_photo" src="' . apply_filters( 'resume_manager_default_candidate_photo', COMPANY_LISTINGS_PLUGIN_URL . '/assets/images/candidate.png' ) . '" alt="Logo" />';
}
