...
if ( is_user_logged_in() && sizeof( $resumes ) ) : ?>
	<form class="apply_with_resume" method="post">
		<p><?php _e( 'Apply using your online resume; just enter a short message to send your application.', 'wp-job-manager-company-listings' ); ?></p>
		<p>
			<label for="resume_id"><?php _e( 'Online resume', 'wp-job-manager-company-listings' ); ?>:</label>
