...
$message['view_resume_link']       = sprintf( __( 'You can view this resume here: %s' ), get_permalink( $resume_id ) ) . "\n";
$message['admin_view_resume_link'] = sprintf( __( 'You can view/edit this resume in the backend by clicking here: %s' ), admin_url( 'post.php?post=' . $resume_id . '&action=edit' ) ) . "\n" . "\n";
